...
import Benefitsprogram from './Benefitsprogram';
import BenefitsStudent from './BenefitsStudent';
import EducationSystem from './EducationSystem';
import Importantfact from "./Importantfact";
import Industry from './Industry';
import NationalEducation from './NationalEducation';
import Solutionknowmore from './Solutionknowmore';
import SolutionSandhan from './SolutionSandhan';
import ProblemStartup from './ProblemStartup';
import Table2 from './Table2';
import Introduction from './Introduction';
import EducationStartup from './EducationStartup';
...
function Startup() {
    ...
    return (
        ...
        <div className="startup">
            <section className="startup_header">
                <Navbar/>
            </section>
            <section>
                <Introduction/>
